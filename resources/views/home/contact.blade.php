...
@section('postscript')
<!-- Google Map -->
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDhHiCbGJG7yz_z_SRU79uHQT4r96eM18Q&sensor=false"></script>
  <script src="{{ asset('template/charity/js/google_map.js') }}"></script>
@stop
